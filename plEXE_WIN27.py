...
class BuildExe:
    def __init__(self):
        #Name of starting .py
        self.script = "pyLAUNCH.py"
 
        #Name of program
        self.project_name = "pyLAUNCH (Python Launcher)"
 
        #Project url
        self.project_url = "http://pylaunch.tuRECRE.com"
 
        #Version of program
        self.project_version = "1.8"
 
        #License of the program
        self.license = "Free!"
 
        #Auhor of program
        self.author_name = "Wildfandango"
        self.author_email = "wildfandango_@hotmail.com"
        self.copyright = "free! 2014"
 
        #Description
        self.project_description = "Front-end for arcade machines"
 
        #Icon file (None will use pygame default icon)
        self.icon_file = "pylaunch.ico"
