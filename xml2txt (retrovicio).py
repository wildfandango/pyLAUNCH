...
def renderTXT(file):
	...
	for node in dom.getElementsByTagName('game'):
		...
		# Nombre
		names[txtROM] = '"'+txtDES+'" year '+txtYEA+' manufacturer "'+txtMAN+'" )'
	...
	for item in index:
		txtDES = 'game ( '+item+' description '+names[item]
